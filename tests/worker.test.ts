...
test("validates public hosts, origins and configuration health", async () => {
  ...
  const rejectedPublicBrowserOrigin = await app.request(
  ...
  const acceptedPublicHost = await app.request(
    "https://worker.example.com/health",
    {
  ...
  const acceptedSameHostOrigin = await app.request(
    "https://worker.example.com/health",
    {
  ...
  const rejectedMismatchedHost = await app.request(
  ...
  const rejectedMismatchedOrigin = await app.request(
    "https://worker.example.com/health",
    {
  ...
  const changedPublicHost = await app.request(
  ...
  const rejectedMalformedPublicUrl = await app.request(
    "https://worker.example.com/health",
    {},
    {
  ...
  const rejectedNonLocalHttpUrl = await app.request(
    "https://worker.example.com/health",
    {},
    {
  ...
  const missingKeysHealth = await app.request(
    "http://localhost/health",
    {
      headers: { Host: "localhost" },
    },
  ...
  const configuredHealth = await app.request(
    "http://localhost/health",
    {
      headers: { Host: "localhost" },
    },
